    ...
    <div className="container max-w-6xl mx-auto px-2 sm:px-5  py-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between mb-4 sm:mb-6 pb-2 sm:pb-3 border-b border-slate-200">
        <div className="items-center flex flex-row gap-2 sm:gap-3">
          ...
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-slate-800">Nova Tarefa</h1>
            <p className="text-xs text-slate-500 mt-0.5 hidden sm:block">Adicione tarefas à sua lista</p>
          </div>
        </div>
      </div>
        ...
        <CardContent className="pt-4 sm:pt-6 px-4 sm:px-6 md:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            <div className="space-y-4 sm:space-y-6">
              ...
              {/* Matéria, prioridade, status - grid responsivo */}
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 mt-2 sm:mt-3">
                <div>
                  <Label
                    htmlFor="materiaId"
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent position="popper" className="border-slate-200 bg-white">
                      ...
                      >
                        <div className="flex items-center">
                          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-amber-500 mr-2"></div>
                          <span className="text-amber-600">Média</span>
                        </div>
                      </SelectItem>
                      <SelectItem
                      ...
                      >
                        <div className="flex items-center">
                          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-red-600 mr-2"></div>
                      ...
                      >
                        <div className="flex items-center">
                          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-purple-600 mr-2"></div>
                          <span className="text-purple-700">Urgente</span>
                        </div>
                      </SelectItem>
                    </SelectContent>
                  </Select>
          ...
          >
            {isLoading ? (
              ...
              <>
                ...
                <span className="hidden sm:block">Salvar tarefa</span>
              </>
            )}
          </Button>
        </CardFooter>
